...
import com.example.smartwallet.Payment;
import com.example.smartwallet.PaymentType;
...
public class PaymentAdapter extends ArrayAdapter<Payment> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (pItem.timestamp == null) {
            itemHolder.tDate.setText("not predicted");
            itemHolder.tTime.setText("not specified");
        }
        else
        {
